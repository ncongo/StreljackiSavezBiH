...
/*for(var i=0; i<datumi.length; i++)
{
	...
	{
		//alert(datumi[j]);
		//alert(datumiNaslovnica.length);
		//alert(datumiNaslovnica[i].innerHTML);
		datumiNaslovnica[i].innerHTML = ispisiDatum(datumiNaslovnica[j].innerHTML);
		j++;
		//if(j >= 7)
		//	j = 0;
	}
...
function prikaziDanasnjeVijesti(){
	sakrijSveNovosti();
	var listaVijestiNovost1 = document.getElementsByClassName("novost1php");
	var listaVijestiNovost2 = document.getElementsByClassName("novost2php");
